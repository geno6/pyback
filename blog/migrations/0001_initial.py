...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_postimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.Post'], related_name='images')),
    ...
    models = {
        ...
        'blog.postimage': {
            ...
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blog.Post']", 'related_name': "'images'"})
        },
        'blog.tag': {
